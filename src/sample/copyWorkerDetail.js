...
import LineChartForHeartBeat from './copyLineChartForHeartBeat';
import LineChartForTemp from './copyLineChartForTemp';
...
export default function WorkerDetail({ worker, open, handleClose }) {

    console.log("Data for detail modal", worker)
    console.log("heartbeat data for detail modal", worker.list[worker.list.length - 1].heartbeat)
